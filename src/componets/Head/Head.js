...
const Head = (props) => {
    return (
      ...
      <li class="logo" >
        <h3 class="font-bold  text-4xl">CodeCollage</h3>
      </li>
      ...
      <li><Link to='/' className=" text-xl list-none no-underline">Home</Link></li>
                <li><Link to='/product' className=" text-xl list-none no-underline ">Lessons</Link></li>
                <li><Link to='/fashion' className=" text-xl list-none no-underline">Quiz</Link></li>
                <li><Link to='/contact' className=" text-xl list-none no-underline">Contact Us</Link></li>
